...
| `references/ci-cd.md`                                      | `.github/workflows/*.yml`, `scripts/getAffectedStorybooks.ts`                                                                                                                         |
...
| `adr/0001-squide-local-modules.md`                         | `ARCHITECTURE.md` (Squide topology section), `apps/host/` directory structure                                                                                                         |
...
| `odr/0003-selective-chromatic-runs.md`                     | `.github/workflows/chromatic.yml`, `scripts/getAffectedStorybooks.ts`                                                                                                                 |
| `odr/0004-jit-packages.md`                                 | `packages/*/package.json` (`exports` fields), `turbo.json` (`dev` task)                                                                                                               |
| `.claude/skills/plantz-scaffold-domain-module/SKILL.md`    | Reference module (`apps/management/plants/**`), `apps/host/src/getActiveModules.tsx`, `apps/host/package.json`, `scripts/getAffectedStorybooks.ts`, root `package.json`               |
| `.claude/skills/plantz-scaffold-domain-storybook/SKILL.md` | Reference storybook (`apps/management/storybook/**`), `.github/workflows/chromatic.yml`, `apps/storybook/.storybook/main.ts`, `scripts/getAffectedStorybooks.ts`, root `package.json` |
