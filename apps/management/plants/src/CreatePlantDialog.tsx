            ...
            <DialogContent className="sm:max-w-lg max-h-[85vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    <div className="flex flex-col gap-1.5">
                        ...
                        <Input id="create-name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Plant name" />
                        {name.trim() === "" && name !== "" && <p className="text-xs text-destructive">Name is required.</p>}
                    </div>
                    <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <Input id="create-quantity" value={wateringQuantity} onChange={(e) => setWateringQuantity(e.target.value)} placeholder="e.g. 200ml" />
                        {wateringQuantity.trim() === "" && wateringQuantity !== "" && <p className="text-xs text-destructive">Watering quantity is required.</p>}
                    </div>
                    <div className="flex flex-col gap-1.5">
                        <Label>First watering date *</Label>
                        <DatePicker value={firstWateringDate} onChange={setFirstWateringDate} placeholder="Pick a date" />
                    </div>
                    <DialogFooter>
