...
import { todayPlantHandlers, plantsDb, defaultSeedPlants } from "../../landing-page/src/mocks/index.ts";

const worker = setupWorker(...todayPlantHandlers);
...
const mswDecorator = (Story: any, context: any) => {
    ...
    useEffect(() => {
        ...
        worker.resetHandlers(...todayPlantHandlers);
        plantsDb.reset(defaultSeedPlants);
